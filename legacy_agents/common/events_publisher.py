...
class EventsPublisher:
    ...
    def publish_run_status_event(
        ...
        try:
            ...
            self.events_api_client.post_run_status(
                RunStatusApiSchema(**event_info), event_source="API"
            )

        except ApiException as e:
            logger.error(f"Exception when calling EventsApi->post_run_status: {e}\n")
            raise e
    ...
    def publish_metric_log_event(
        ...
        try:
            ...
            self.events_api_client.post_metric_log(
                MetricLogApiSchema(**event_info), event_source="API"
            )

        except ApiException as e:
            logger.error(f"Exception when calling EventsApi->post_metric_log: {e}\n")
            raise e
    ...
    def publish_message_log_event(
        ...
        try:
            ...
            self.events_api_client.post_message_log(
                MessageLogEventApiSchema(**event_info), event_source="API"
            )

        except ApiException as e:
            logger.error(f"Exception when calling EventsApi->post_message_log: {e}\n")
            raise e
    ...
    def publish_test_outcomes_event_dataset(
        ...
        if not self.publish_events:
            logger.debug(
                f"publish_test_outcomes_event() called with test outcomes '{test_outcomes}'"
            )
            return
        try:
            event_info = {
            ...
            self.events_api_client.post_test_outcomes(
                TestOutcomesApiSchema(**event_info), event_source="API"
            )

        except ApiException as e:
            logger.error(f"Exception when calling EventsApi->post_test_outcomes: {e}\n")
            raise e
    ...
    def publish_dataset_event(
        ...
        try:
            ...
            self.events_api_client.post_dataset_operation(
                DatasetOperationApiSchema(**event_info), event_source="API"
            )

        except ApiException as e:
            logger.error(f"Exception when calling EventsApi->post_dataset_operation: {e}\n")
            raise e
